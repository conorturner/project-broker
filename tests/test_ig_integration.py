...
class IGIntegrationTestCase(unittest.IsolatedAsyncioTestCase):
    async def test_make_request(self):
        ...
        with mock.patch('aiohttp.ClientSession.request',
            ...
            with mock.patch('app.modules.broker_integrations.ig_api.IGIntegration._IGIntegration__headers',
    ...
    async def test_market_search(self):
        ...
        with mock.patch('app.modules.broker_integrations.ig_api.IGIntegration._IGIntegration__make_request',
