import os
import unittest
from app.modules.broker_integrations.capital_api import CapitalClientAsync
...
class CapitalTestCase(unittest.IsolatedAsyncioTestCase):
    async def test_all_accounts(self):
        client = CapitalClientAsync(CAPITAL_USER, CAPITAL_API_KEY, CAPITAL_PASS, demo=True)
